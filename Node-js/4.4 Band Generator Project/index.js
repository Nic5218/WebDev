...
app.post("/submit", (req, res) => {
  ...
  const adj_picked = adj[Math.floor(Math.random() * adj.length)];
  const noun_picked = noun[Math.floor(Math.random() * noun.length)];
  //scroll down to see the two arrays.
  //2. Send the index.ejs as a response and add the adjective and noun to the res.render
  res.render("index.ejs", {adjective: adj_picked, noun: noun_picked});
